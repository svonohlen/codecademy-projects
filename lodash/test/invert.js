...
assert.equals(
  ...
  _.invert({ originalKey: "originalValue", originalKey2: "originalValue2"  })["originalValue"],
  "originalKey"
);
assert.equals(
  TEST_NAME,
  ...
  _.invert({ originalKey: "originalValue", originalKey2: "originalValue2" })["originalKey"],
  undefined
);
